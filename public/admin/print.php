...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>TATAG AMS CORPORATION,</p>
				<p>Purok 6A,<br> Brgy Sto. Niño, Talaingod, Davao del Norte,<br>Philippines.</p>
				<p>(+63)960 484 2954</p>
			</address>
			<span><img alt="" src="assets/img/ttipr_transcript.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- tatagipstudentsfoundation@gmail.com || Web :- tatagip.com || Phone :- (+63)960 484 2954 </p>
			</div>
		</aside>
	</body>
</html>
